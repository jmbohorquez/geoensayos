...
export const metadata: Metadata = {
    title: "Acuerdo de confidencialidad | Geoensayos",
...
export default function acuerdoConfidencialidad(){
    return(
        <>
            ...
            <main className="legales-main-content">
                <div className="legales-main-inner">
                    ...
                    <p className="mb-4"><strong>Tercera</strong> Sin perjuicio de lo estipulado en el presente Compromiso, la obligación de confidencialidad no se aplicará en los siguientes casos:
                        <ol>
                    ...
                    <p className="mb-4"><strong>Cuarta</strong> Los derechos de propiedad intelectual de la información objeto de este Acuerdo pertenecen al cliente o GEOENSAYOS según autoría, y en caso de revelarla no cambiará tal situación. </p>
                    ...
                    <p className="mb-4"><strong>Quinta</strong> Todo el personal del laboratorio y los terceros que correspondan se comprometen a ejecutar sus actividades de manera imparcial, dando cumplimiento a la Política de Imparcialidad y Confidencialidad, por tanto, no aceptará ofrecimientos, regalos, invitaciones o cualquier tipo de soborno. Ni participación en lavado de activos o extorsión.</p>
                    <p className="mb-4">No se permite prometer, ofrecer o dar cualquier beneficio o ventaja de cualquier naturaleza, de forma directa o indirecta (a través de un tercero) con el fin de influir en decisiones de cualquier tipo u obtener ventajas indebidas. </p>
                    <p className="mb-4">Cualquier violación a la imparcialidad por parte de los trabajadores de Geo Ensayos, se considerará una falta grave de acuerdo con lo establecido en el reglamento interno de Trabajo, además de las penales consagradas en la ley. Para las demás partes interesadas, este incumplimiento generará desde quejas hasta sanciones consagradas en la ley.</p>
                    <p className="mb-4"><strong>Sexta</strong> El presente Acuerdo entrará en vigor en el momento de la aceptación de este por parte del cliente u otra parte interesada, extendiéndose su vigencia indefinida o hasta tanto la parte lo permita su divulgación por escrito.</p>
                    <p className="mb-4"><strong>Septima</strong> En caso de cualquier conflicto o discrepancia que pueda surgir en relación con la interpretación y/o cumplimiento del presente Compromiso, el Laboratorio se someterá a la legislación vigente.</p>
                    <p className="mb-4"><strong>Octava</strong> Para el caso del manejo de información que incluya datos personales, el GEOENSAYOS dará estricto cumplimiento a las disposiciones constitucionales y legales sobre la protección del derecho fundamental de habeas data, en particular lo dispuesto en el artículo 15 de la Constitución Política y la ley 1581 de 2012. </p>
